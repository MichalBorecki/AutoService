...
<body>
	...
	<div class="container">
		...
		<form action="VehicleCreate" method="post">
			...
			<div class="form-group col-md-3">
				<label for="model">Model:</label> <input class="form-control" id="model" type="text" name="model" required>
			</div>

			<div class="form-group col-md-3">
				<label for="year">Rok produkcji:</label> <input class="form-control" id="year" type="number" min="1930" max="2050"
					step="1" value="2018" name="year" required>
			</div>

			<div class="form-group col-md-3">
				<label for="nextServicingDate">Data kolejnego przeglądu technicznego:</label> <input class="form-control"
					id="nextServicingDate" type="date" name="next_servicing_date" required>
			</div>
			...
			<div class="form-group col-md-6">
				<label for="customerId">Dane właściciela:</label> <select class="form-control" id="customerId" name="customer_id"
					required>
					<option disabled selected value>-- wybierz klienta --</option>
					<c:forEach var="customer" items="${customers }">
						<option value="${customer.id }"><c:out
